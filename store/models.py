...
#     bought_by = db.relationship('BoughtItems', backref='bought_by', lazy=True)
#
...
#     amount_in_acc = db.Column(db.Numeric(precision=20, scale=2))
#     # Hashing the password:
#     password_hash = db.Column(db.String(length=60), nullable=False)
#     rel = db.relationship('BoughtItems', backref='owned_user', lazy=True)
#     @property
#     #the getter func
#     def password(self):
...
#     item_barcode = db.Column(db.Integer(), db.ForeignKey('item.barcode'))
